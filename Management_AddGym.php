...
require 'Connection.php';
  ...
  if (!empty($_POST['Gym']) && !empty($_POST['Estado'])) {
    //Parametros recibidos
    $Gym = $_POST['Gym'];
    $Estado = $_POST['Estado'];

    $sql = "INSERT INTO `tbl_gimnasio`(`GimnasioName`,`Estado`)" .
    " VALUES ('$Gym','$Estado')";
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
						<hr>
						<h2 class="intro-text text-center">Gym</h2>
						<hr>

					<div class="col-md-12">	
						<div class="col-md-6">	
							<form role="form" action="Management_AddGym.php" method="POST" >
	
							
							<div class="form-group">
							  <label for="Gym">Nombre de Gym:</label>
							  <input type="text" name="Gym" class="form-control" id="Gym" placeholder="Ingresa el nombre de tu Gym" required>
                         </div>
...
<div class="row">
    <div class="box">
        <div class="col-lg-12">
                <hr>
                <h2 class="intro-text text-center">Gym Afiliados</h2>
                <hr>
                <div class="table-responsive">
                    <table border="5px" class="table">
                        ...
                        <?php 
                        require 'Connection.php';
                        $sqlI = "SELECT * from tbl_gimnasio WHERE Estado='Activo'";
                        ...
                        <td>
                        <a href="#" onclick="DeleteGymOnclick(<?php echo $Rows[0]; ?>);">Eliminar</a>
                        </td>
                        <?php endwhile; ?>
                        </tr>
                    </table>
	...
	<script>
			function DeleteGymOnclick(ID)
		{
			if(confirm("Are you sure you want to Delete this Gym?")==true)
			{
				window.open("DeleteGym.php?id="+ID,"",null,true);
			}
		}
