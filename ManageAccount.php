						...
						<hr>
					       <div class="col-md-6">	
							...
							<div class="form-group">
							  ...
							  <input type="text" name="Username" class="form-control" id="Username" value="<?php if(isset($C_Username)){ echo $C_Username;} ?>" disabled>
							</div>
							
							<div class="form-group">
							  <label for="Password">Password:</label>
							  <input type="Password" name="Password" class="form-control" id="Password" value="<?php if(isset( $C_Password)){ echo $C_Password;} ?>" disabled>
							</div>

							<div class="form-group">
							  <label for="Firstname">Firstname:</label>
							  <input type="text" name="Firstname" class="form-control" id="Firstname" value="<?php if(isset($C_Firstname)){ echo $C_Firstname;} ?>" disabled>
							</div>
							
							<div class="form-group">
							  <label for="Middlename">Middlename:</label>
							  <input type="text" name="Middlename" class="form-control" id="Middlename" value="<?php if(isset($C_Middlename)){ echo $C_Middlename;} ?>" disabled>
							</div>
							
							<div class="form-group">
							  <label for="Lastname">Lastname:</label>
							  <input type="text" name="Lastname" class="form-control" id="Lastname" value="<?php if(isset($C_Lastname)){echo $C_Lastname; }?>" disabled>
							</div>
							
							<div class="form-group">
							  <label for="Address">Address:</label>
							  <input type="text" name="Address" class="form-control" id="Address" value="<?php if(isset($C_Address)){ echo $C_Address;} ?>" disabled>
							</div>
							
							<div class="form-group">
							  <label for="EmailAddress">Email Address:</label>
							  <input type="email" name="EmailAddress" class="form-control" id="EmailAddress" value="<?php if(isset($C_Email)){ echo $C_Email;} ?>" disabled>
							</div>
					...
					<div class="col-md-6">	
						...
						<div class="table-responsive">
							<table border="5px" class="table">
								...
								tbl_orders on tbl_orders.PlatilloID = tbl_platillos.PlatilloID WHERE tbl_orders.CustomerID = $C_ID ORDER BY tbl_orders.OrderID";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; Entregas Narime</p>
                </div>
            </div>
        </div>
    </footer>
