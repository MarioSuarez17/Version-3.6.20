...
if (empty($Username) || empty($Password) || empty($Firstname) || empty($Middlename) || empty($Lastname) || empty($Address) || empty($EmailAddress)|| empty($Gym)) {
	...
	if ($ActionType == "Register") {
		...
		$sql = "INSERT INTO `tbl_customers`(`Username`,`Password`,`Role`,`Firstname`, `Middlename`, `Lastname`, `Address`, `EmailAddress`, `GinmasioID`)" .
			" VALUES ('$Username','$Password','User','$Firstname','$Middlename','$Lastname','$Address','$EmailAddress',$Gym)";
