    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
					<hr>
					<h2 class="intro-text text-center">Lista de Productos Desactivados</h2>
					<hr>
					<div class="col-lg-12">
						<div class="table-responsive">
							<table border="5px" class="table">
								...
								<tr style="color: black"> <!--Establece el tamaño-->
									...
									<td>
									<!--<a href="#" onclick="ProductOnlick('Edit',)">Editar</a> | -->
									<a href="#" onclick="ProductOnlick('Activo',<?php echo $Rows[0]; ?>)">Activo</a>
									</td>
									<?php endwhile; ?>
								</tr>
							</table>
